...
export default function EventDetail() {
  ...
  const event = {
    ...
    description:
      "Uma corrida leve e comunitária pelas ruas históricas do Recife antigo. Ideal para quem busca saúde, conexão e paisagens incríveis",
    location: "Marco Zero - PE",
    date: "26/11/2025",
    image:
      "https://images.unsplash.com/photo-1476480862126-209bfaa8edc8?w=800&h=480&fit=crop",
    mapImage:
      "https://images.unsplash.com/photo-1524661135-423995f22d0b?w=800&h=360&fit=crop",
  };
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="px-6 pt-4">
        ...
        <div className="relative mb-6">
          ...
          />
          <svg
            className="absolute right-4 top-1/2 -translate-y-1/2 w-6 h-6 text-cony-green"
            fill="currentColor"
            viewBox="0 0 24 24"
          >
        ...
        <div className="bg-white rounded-[30px] shadow-sm border border-black/5 overflow-hidden">
          ...
          <div className="p-6">
            ...
            <div className="flex gap-2 mb-8">
              ...
              >
                <Heart
                  className={`w-5 h-5 ${liked ? "fill-white text-white" : "text-cony-green"}`}
                />
              </button>
            </div>
